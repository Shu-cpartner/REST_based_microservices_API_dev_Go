...
func (d AccountRepositoryDb) Save(a Account) (*Account, *errs.AppError) {
	...
	if err != nil {
		...
		return nil, errs.NewUnexpectedError("Unexpect4ed error from database")
	}
...
func (d AccountRepositoryDb) SaveTransaction(t Transaction) (*Transaction, *errs.AppError) {
	...
	result, _ := tx.Exec(`INSERT INTO transactions (account_id, amount, trasaction_type, transaction_date)
	...
	// in case of error Rollback, and changes from both the tables vill be reverted
	if err != nil {
		tx.Rollback()
